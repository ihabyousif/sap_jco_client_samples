...
public class TestSAPConnection {
    // make sure that current user have access to this folder 
	 ...
	 private static CustomDestinationDataProvider customDestinationDataProvider;
	 ...
	 public static void main(String[] args) throws JCoException {
		...
		if (customDestinationDataProvider == null) {
			...
			com.sap.conn.jco.ext.Environment.registerDestinationDataProvider(customDestinationDataProvider);
		}
